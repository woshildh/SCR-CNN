...
class ResNeXt(nn.Module):
	...
	"""
	def __init__(self, baseWidth, cardinality, layers):
		""" Constructor
		Args:
...
def resnext50(baseWidth, cardinality):
	...
	"""
	model = ResNeXt(baseWidth, cardinality, [3, 4, 6, 3])
	return model
...
def resnext101(baseWidth, cardinality):
	...
	"""
	model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3])
	return model
...
def resnext152(baseWidth, cardinality):
	...
	"""
	model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3])
	return model

if __name__=="__main__":
	model=resnext50(baseWidth=16,cardinality=4)
	...
	inputs=torch.autograd.Variable(torch.randn(1,3,224,224))
